...
# These allow direct imports: from src.config import SEQUENCE_LENGTH
# ============================================================

# Video sequence parameters (aliases for Config class attributes)
SEQUENCE_LENGTH = Config.FRAMES_PER_VIDEO  # 20 frames per video
IMG_HEIGHT = Config.IMG_SIZE              # 224 pixels
IMG_WIDTH = Config.IMG_SIZE               # 224 pixels
IMG_SIZE = Config.IMG_SIZE                # 224 pixels
NUM_CHANNELS = Config.NUM_CHANNELS        # 3 (RGB)

# Training parameters
BATCH_SIZE = Config.BATCH_SIZE            # 64
EPOCHS = Config.EPOCHS                    # 250
LEARNING_RATE = Config.LEARNING_RATE      # 0.0001

# Model parameters
NUM_CLASSES = Config.NUM_CLASSES          # 2 (Violence/Non-violence)
RNN_SIZE = Config.RNN_SIZE                # 128
DROPOUT_RATE = Config.DROPOUT_RATE        # 0.5

#!/usr/bin/env python3
"""
NexaraVision Model Architecture (FIXED)
...
class ViolenceDetectionModel:
    ...
    def build_model(self, trainable_backbone=False):
        ...
        if self.sequence_model_type.upper() == 'GRU':
    ...
    def compile_model(self,
                     ...
                     metrics=None):
        """Compile model with optimizer and loss (FIXED - case insensitive)"""
        ...
        # Create optimizer (case-insensitive)

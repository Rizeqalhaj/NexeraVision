#!/usr/bin/env python3
"""
Download LONG-FORM YouTube non-violence videos
Then extract 16-frame clips from them (simulating CCTV sampling)
"""
...
# CONFIGURATION
# ============================================================================
JSON_FILE = "/workspace/youtube_long_nonviolence_links.json"
OUTPUT_DIR = Path("/workspace/youtube_long_videos")
CLIPS_DIR = Path("/workspace/youtube_long_clips")  # Extracted clips
...
# ============================================================================
print("=" * 80)
print("LONG-FORM YOUTUBE VIDEO DOWNLOADER")
print("=" * 80)
print()
    ...
    try:
        ...
        for attempt in range(RETRY_ATTEMPTS):
            try:
                cmd = [
                    'yt-dlp',
                    '--format', 'best[height<=480]/best',  # 480p max to save space
                    ...
                    '--retries', '3',
                    '--fragment-retries', '3',
                    # Duration limit: 5-30 minutes
                    '--match-filter', 'duration > 300 & duration < 1800',
                    url
                ]
    ...
    for future in as_completed(futures):
        ...
        if current_time - last_print_time >= print_interval:
            with progress_lock:
                ...
                percent = (total_processed * 100) // len(urls) if len(urls) > 0 else 0
...
print("Next step:")
print("  Extract short clips from these long videos:")
print("  python3 extract_clips_from_long_videos.py")
print()

#!/usr/bin/env python3
"""
Test All Violence Detection Models - Proper Keras 3 Loading
...
# ============================================================================
# MODEL ARCHITECTURE (from violence_detection_mvp/src/model_architecture.py)
# ============================================================================
...
def load_model_from_h5(model_path):
    """Load complete model from H5 file with custom layers"""
    try:
        # Try loading the complete model (not just weights)
...
def main():
    ...
    for model_name in CONFIG['models']:
        ...
        model = load_model_from_h5(str(model_path))
        if model:

#!/usr/bin/env python3
"""
Single Video Violence Detection Test
Tested on Vast.ai with baseline model (87.84% validation accuracy)
"""
import os
...
# CRITICAL: Make tf globally available for Lambda layer deserialization
import builtins
builtins.tf = tf

# CRITICAL: Enable Lambda layer loading (required for baseline model)
